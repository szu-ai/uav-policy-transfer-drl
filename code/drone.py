...
def parse_args():
    ...
    parser.add_argument("--mode", type=str, default="train", choices=["train", "random", "collect_uniform_speed", "build_op_cbrs_library", "train_e1_osd", "transfer_e2", "eval_baselines", "eval_transfer", "paper_pipeline"], help="Algorithmic mode: PPO train/eval, offline uniform-speed collection, OP-CBRS library, Sim2Sim transfer, or full paper pipeline.")
...
def main():
    ...
    def _write_algorithm_manifest(stage_name: str, extra: Optional[Dict[str, object]] = None):
        ...
        manifest = {
            "stage": stage_name,
            "methodology": "MDP + PPO-learned OSD + fuzzy inference + OP-CBRS + Sim2Sim transfer + VSLAM localization",
